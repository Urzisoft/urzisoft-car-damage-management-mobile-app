...
export const RoutesMapping = () => {
    ...
    return (
        <Navigator screenOptions={tabBarOptions} initialRouteName={RouterKey.BOTTOM_TAB_NAVIGATOR}>
            {screenRoutes.map(route => {
                return <Screen key={route.name} name={route.name} component={route.component} />;
            })}
        </Navigator>
    );
};
